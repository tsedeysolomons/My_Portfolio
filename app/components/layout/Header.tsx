...
export const Header = ({ onToggle }: { onToggle: () => void }) => {
  return (
    <header className="sticky top-0 z-40 py-4 px-6 flex items-center justify-between border-b border-gray-800 bg-gray-900">
      <div className="text-xl font-bold text-white">DevPortfolio</div>
      ...
      <div className="flex items-center gap-3">
        {/* Toggle Button */}
        <button
          onClick={onToggle} // Call the onToggle function passed as a prop
        ...
        <a
          ...
          className="px-4 py-2 border border-gray-700 rounded-md text-white hover:bg-gray-800 transition"
          target="_blank"
