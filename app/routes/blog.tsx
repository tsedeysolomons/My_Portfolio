        ...
        <article className="glass-card p-8 md:p-12">
          ...
          <div className="prose prose-invert prose-brand max-w-none text-gray-500 dark:text-gray-400 leading-relaxed text-lg sanity-content">
            <PortableText
              ...
              components={{
                block: {
                  h1: ({ children }) => (
                    <h1 className="text-3xl font-black mb-6 mt-12 text-white">
                      {children}
                    </h1>
                  ),
                  h2: ({ children }) => (
          ...
          <div className="mt-12 pt-8 border-t border-gray-200/10 flex flex-wrap gap-2">
            {selectedPost.tags?.map((tag, i) => (
              <span
                key={i}
                className="px-3 py-1 rounded-full bg-gray-100 dark:bg-white/5 text-gray-400 text-xs font-bold"
              >
                #{tag}
              </span>
            ))}
            ...
            <form onSubmit={handlePostComment} className="space-y-6">
              ...
              <div className="flex items-center justify-between pt-4">
                <p className="text-[11px] text-gray-500 dark:text-gray-500 max-w-xs italic">
                  Your email address is required for verification and will not
                  be shared publicly.
                </p>
                <button
                  type="submit"
    ...
    <div className="py-24 px-6 max-w-7xl mx-auto min-h-screen">
      ...
      >
        <h2 className="text-4xl md:text-7xl font-black mb-6 tracking-tight">
          Inside My <span className="text-brand-500">Mind</span>
        </h2>
        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
          Sharing knowledge, building tutorials, and exploring the intersection
          of design and deep tech.
        </p>
      </motion.div>
          ...
          {categories.map((cat) => {
            const categoryButtonClass =
              ...
              (selectedCategory === cat
                ...
                : "hover:bg-brand-500/10 text-gray-500");
