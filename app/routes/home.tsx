...
// Animation variants for scroll-based triggers
      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 mb-8 px-4 py-1.5 rounded-full bg-brand-500/10 text-brand-500 text-[11px] font-black uppercase tracking-widest border border-brand-500/20"
            >
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-8xl font-black leading-[0.85] tracking-tighter mb-10 max-w-2xl bg-gradient-to-br from-gray-900 to-gray-500 dark:from-white dark:to-gray-400 bg-clip-text text-transparent"
            >
            ...
            <motion.p 
              ...
              className="text-lg md:text-2xl text-gray-500 dark:text-gray-400 max-w-2xl leading-relaxed mb-10"
            >
            ...
            >
              {["Full-Stack", "TS / JS", "Python", "Cloud", "UI/UX", "API Design"].map((item) => (
                <motion.div 
                  ...
                  className="p-3 rounded-2xl bg-gray-100 dark:bg-white/5 border border-transparent hover:border-brand-500/30 transition-all flex items-center gap-2"
                >
        ...
        >
          <div>
            ...
            >
              ...
              <motion.div 
                variants={staggerItem}
                className="relative pl-6 border-l border-gray-200/20"
              >
        ...
        >
          ...
          >
            <motion.p 
              variants={staggerItem}
              className="text-xl md:text-2xl font-black italic tracking-tight mb-4 text-gray-800 dark:text-gray-100"
            >
              "{quote.text}"
            </motion.p>
            <motion.cite 
              variants={staggerItem}
              className="text-sm font-bold uppercase tracking-[0.3em] text-brand-500 not-italic"
            >
              — {quote.author}
            </motion.cite>
          </motion.blockquote>
